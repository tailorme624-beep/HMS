    ...
    <div class="container-fluid  dashboard-content">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Add Borrow</h5>
                    <div class="card-body">
                      ...
                      foreach ($record as $res) { ?>
                        ...
                        <?php echo $res['fname'];?>  <?php echo $res['lname'];
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="amount" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="Amount">
                                    <div class="valid-feedback"></div>
                                </div>

                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                    <label for="validationCustom02">Reason</label>
                                    <textarea type="text" class="form-control" name="reason" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="Reason"></textarea>
                                    <div class="valid-feedback"></div>
                                </div>

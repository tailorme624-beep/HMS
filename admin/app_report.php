...
// print_r($_POST);exit;
                                        ...
                                        $sql = "SELECT * FROM leaves WHERE delete_status='0' AND status=? AND date between ? and ?";
...
// print_r($rec);exit;
                                   foreach($rec as $key)
                                   {
                                    ...
                                    $stmt2->execute([$key['user']]);
                                   // print_r($stmt2);exit;
                                    $record2 = $stmt2->fetch();
                                      echo $record2['fname'] . ' ' . $record2['lname']; ?></td>
                                           
                                                    <td><?php echo $key['date'];?></td>
                                                     <td><?php if($key['type']=='1'){echo "Paid";}elseif($key['type']=='2'){echo 'Unpaid';}?></td>

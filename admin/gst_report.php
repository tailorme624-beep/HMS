...
<div class="dashboard-wrapper">
    ...
    WHERE  created_date >='" . $fromdate . "' and created_date <='" . $todate . "' and delete_status='0' ";
                                    } else {
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                          ...
                                          <td><?= $row1['size']; ?></td>
                                            ...
                                            <td><?= $row2['quantity']; ?></td>
                                            <td><?= $row1['unit_price'] * $row2['quantity']; ?></td>
                                            <!-- <td><?= ($row1['unit_price'] * $item['total_qty']) - ($row1['purchase_price'] * $item['total_qty']); ?></td>
                                             -->
                                             <td><?= $item['gst_rate']; ?>%</td>
                                             <?php
                                        $gst_rate = $item['gst_rate']; // GST rate
